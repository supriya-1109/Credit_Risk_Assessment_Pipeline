...
This folder defines all source code for the 'gold_pipeline_new' pipeline:
...
* Take a look at the sample under "sample_users_gold_pipeline_new.py" to get familiar with the syntax.

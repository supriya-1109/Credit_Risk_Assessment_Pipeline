...
This folder defines all source code for the 'new_silver_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_new_silver_pipeline.py" to get familiar with the syntax.
